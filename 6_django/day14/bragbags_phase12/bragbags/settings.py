"""
Django settings for bragbags project.
...
SECRET_KEY = 'django-insecure-l51773eixm2p-+2=yp=fsta*p)t3(p_ndx-zgo!*hs2plgaf5j'
...
WSGI_APPLICATION = 'bragbags.wsgi.application'
...
USE_TZ = True  # Keep this True to store timestamps in UTC
