# Generated by Django 5.1.6 on 2025-03-08 19:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('SUITCASE', 'Suitcase'), ('BAGPACKS', 'Bagpacks'), ('DUFFLE', 'Duffle'), ('BRIEFCASE', 'Briefcase')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.luggage')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('pet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.luggage')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
